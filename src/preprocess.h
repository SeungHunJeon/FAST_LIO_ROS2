...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const raisin_lidar_helper::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const raisin_lidar_helper::msg::CustomMsg::UniquePtr &msg);
